...
"""
import sys
sys.path.append('c:\\Users\\Administrator\\Documents\\ITS\\its_src')
...
# file directory
cur_dir = os.path.join(os.path.dirname(os.getcwd()), 'scripts')
...
def pt_metadata(pt_feature_class):
    ...
    shutil.copy(os.path.join(cur_dir, 'ITS Logos.jpg'),'ITS Logos2.jpg') # copy the file because md.thumbnailUri usually deletes the file after import
