...
def ownership(delete_scratch=True):
    with arcpy.EnvManager(
        ...
        forest_own1_tif = "C:\\Users\\Administrator\\Documents\\ITS\\its_src\\RDS-2020-0044\\Data\\forest_own1\\forest_own1.tif"
        ...
        # reclas_own.save('C:\\Users\\Administrator\\Documents\\ITS\\its_src\\ownership_reclassify.tif')

        reclas_own = arcpy.Raster('C:\\Users\\Administrator\\Documents\\ITS\\its_src\\ownership_reclassify.tif')
        ...
        save_features_repair_1 = arcpy.management.RepairGeometry(
            in_features=save_features_1
        )

        print("   setp 2/3: add field")
        add_field_1 = arcpy.management.AddField(
            in_table=save_features_repair_1,
