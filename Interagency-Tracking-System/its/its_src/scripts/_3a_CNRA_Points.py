...
def CNRA_pts_Model(
    ...
    with arcpy.EnvManager(
        ...
        calc_field_3 = arcpy.management.CalculateField(
            ...
            # expression="ifelse(!TREATMENTID_!,!TREATMENTID_LN!,!TREATMENTID_PT!, 'TRMT_GEOM')",
            # code_block="""def ifelse(poly, ln, pt, gt):
            #                 if gt == 'POINT':
            #                     return pt
            #                 else:
            #                     return None""",
        ...
        MiliSeconds_2 = arcpy.AddField_management(MiliSeconds_1, "ACTIVITY_END", "DATE")
        ...
        MiliSeconds_6 = arcpy.AddField_management(MiliSeconds_5, "ACTIVITY_END", "DATE")
        ...
        cnra_flat_2_geom_type = arcpy.Describe(CNRA_Flat_2).shapeType
        standardized_geom_type = arcpy.Describe(standardized_1).shapeType
        print(f"======> cnra_flat_2_geom_type: {cnra_flat_2_geom_type}")
        print(f"======> standardized_geom_type: {standardized_geom_type}")
