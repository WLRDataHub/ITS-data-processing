...
def veg():
    with arcpy.EnvManager(
        ...
        # CalVeg = arcpy.Raster("https://egis.fire.ca.gov/arcgis/rest/services/FRAP/fveg/ImageServer")

        arcpy.env.cellSize = 500
        CalVeg = arcpy.management.CopyRaster("https://egis.fire.ca.gov/arcgis/rest/services/FRAP/fveg/ImageServer", "C:\\Users\\Administrator\\Documents\\ITS\\its_src\\calveg.tif")
