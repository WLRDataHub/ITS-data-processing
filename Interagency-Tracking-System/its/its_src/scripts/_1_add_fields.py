...
def AddFields(Input_Table, alter_fields=False):
    ...
    schema = [
        ...
        # changed xxx_OBJECTIVE size from 65 to 255
        ["PRIMARY_OBJECTIVE", "TEXT", "PRIMARY OBJECTIVE", "255", "", ""],
        ["SECONDARY_OBJECTIVE", "TEXT", "SECONDARY OBJECTIVE", "255", "", ""],
        ["TERTIARY_OBJECTIVE", "TEXT", "TERTIARY OBJECTIVE", "255", "", ""],
        ["TREATMENT_STATUS", "TEXT", "TREATMENT STATUS", "255", "", ""],
        ["COUNTY", "TEXT", "COUNTY", "255", "", ""],
        ...
        ["ACTIVITY_DESCRIPTION", "TEXT", "ACTIVITY DESCRIPTION", "255", "", ""],
        ["ACTIVITY_CAT", "TEXT", "ACTIVITY CATEGORY", "40", "", ""],
        ["BROAD_VEGETATION_TYPE", "TEXT", "BROAD VEGETATION TYPE", "255", "", ""],
        ["BVT_USERD", "TEXT", "IS BVT USER DEFINED", "30", "", ""],
        ["ACTIVITY_STATUS", "TEXT", "ACTIVITY STATUS", "255", "", ""],
